...
ConcreteMediator ..|> Meidator : Realization
class Colleague
Colleague: -Meidator mediator
Colleague --> Meidator : Association
class ConcreteColleagueA
Colleague <|-- ConcreteColleagueA : Inheritance
class ConcreteColleagueB
Colleague <|-- ConcreteColleagueB : Inheritance
```
